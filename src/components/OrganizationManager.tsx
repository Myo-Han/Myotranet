...
import ApprovalLineManager from './ApprovalLineManager';
...
const OrganizationManager: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'org' | 'approval_lines'>('org');
    ...
    <div className="space-y-4">
      ...
      <div className="flex space-x-2 border-b">
        <button
          ...
          className={`px-4 py-2 text-sm font-medium ${activeTab === 'org' && activeSection === 'departments'
        ...
        <button
          ...
          className={`px-4 py-2 text-sm font-medium ${activeTab === 'org' && activeSection === 'projects'
              ? 'border-b-2 border-blue-600 text-blue-600'
              : 'text-gray-500 hover:text-gray-700'
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 text-sm font-medium ${activeTab === 'org' && activeSection === 'parts'
              ? 'border-b-2 border-blue-600 text-blue-600'
              : 'text-gray-500 hover:text-gray-700'
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 text-sm font-medium ${activeTab === 'org' && activeSection === 'positions'
              ? 'border-b-2 border-blue-600 text-blue-600'
              : 'text-gray-500 hover:text-gray-700'
            }`}
        >
        ...
        <button
          onClick={() => {
            setShowModal(false);
            setActiveTab('approval_lines');
          }}
          className={`px-4 py-2 text-sm font-medium ${activeTab === 'approval_lines'
              ? 'border-b-2 border-blue-600 text-blue-600'
              : 'text-gray-500 hover:text-gray-700'
            }`}
        >
